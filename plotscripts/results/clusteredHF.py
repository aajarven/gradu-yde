...
#	print(stats.ttest_ind(allH0s, outClusterH0s))
	print("all vs in H0")
	print(stats.ks_2samp(allH0s, inClusterH0s))
#	print(stats.ttest_ind(allH0s, inClusterH0s))
	print("all vs mass cut H0")
	print(stats.ks_2samp(allH0s, massCutH0s))
#	print(stats.ttest_ind(allH0s, massCutH0s))
	print("in vs mass cut H0")
	print(stats.ks_2samp(inClusterH0s, massCutH0s))
#	print(stats.ttest_ind(inClusterH0s, massCutH0s))
	print("")
	print("all vs out zeros")
	print(stats.ks_2samp(allZeros, outClusterZeros))
#	print(stats.ttest_ind(allZeros, outClusterZeros))
	print("all vs in zeros")
	print(stats.ks_2samp(allZeros, inClusterZeros))
#	print(stats.ttest_ind(allZeros, inClusterZeros))
	print("all vs mass cut zeros")
	print(stats.ks_2samp(allZeros, massCutZeros))
	print("in vs mass cut H0")
	print(stats.ks_2samp(inClusterZeros, massCutZeros))
	print("")
	print("all vs out dispersion")
	print(stats.ks_2samp(allDispersions, outClusterDispersions))
#	print(stats.ttest_ind(allDispersions, outClusterDispersions))
	print("out vs in dispersion")
	print(stats.ks_2samp(outClusterDispersions, inClusterDispersions))
#	print(stats.ttest_ind(outClusterDispersions, inClusterDispersions))
	print("in vs mass cut dispersion")
	print(stats.ks_2samp(inClusterDispersions, massCutDispersions))
#	print(stats.ttest_ind(inClusterDispersions, massCutDispersions))
	
	print("")
	print("medians:")
	print("all H0s:", np.median(allH0s))
	print("out H0:", np.median(outClusterH0s))
	print("in H0:", np.median(inClusterH0s))
	print("mass cut H0:", np.median(massCutH0s))
	print("all zeros:", np.median(allZeros))
	print("out zeros:", np.median(outClusterZeros))
	print("in zeros:", np.median(inClusterZeros))
	print("mass cut zeros", np.median(massCutZeros))
