...
\end{equation}
The first measurements trying to determine the current value of the Hubble parameter, often called the Hubble constant, were prone to error as the distance estimates to extragalactic objects were inaccurate. Later estimates offer reasonably accurate results such as the \citet{planck2014resultsXVI} value of $67.77 \pm 0.77$~km/s/Mpc for the current expansion speed, though the results of different experiments have considerable scatter.
...
TODO: simulation properties, both cosmology and resolution related, starting resolution. Softening length 1.0 kpc/h in all zooms.
...
\begin{table}
	...
	\begin{tabular}{| l | l | l | l | l |}
		...
		High resolution particles & 0???? & 8,818,814 & 6,527,499 & 29,791,000 \\ \hline
		High resolution particle mass  & min & mean & median & max \\ \hline
		Total particles  & 4,311,924 & 11,317,292 & 9,007,232 & 31,864,792 \\ \hline
	\end{tabular}
