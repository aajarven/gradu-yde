...
\end{align}
where $G$ is the gravitational constant, $P$ is pressure, $\rho$ is density and $K$, $\Lambda$ and $a$ are parameters that define the cosmology \citep{mo2010galaxy}. $K$ specifies the curvature of the universe, determined by the overall density of the universe \citep{mo2010galaxy}. The allowed values being for $K$ are $-1$ corresponding to a hyperbolic universe, $0$ to a flat one and $1$ to a spherical universe \citep{mo2010galaxy}. Modern measurements suggest that the Universe is flat within the measurement error, but small deviations from the $K=1$ cannot be eliminated \citep{planck2016resultsI}. $\Lambda$ is the cosmological constant driving the expansion of the universe, often described as vacuum energy \citep{mo2010galaxy}.

The most relevant of these cosmological parameters is the scale factor $a$. It 
