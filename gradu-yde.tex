...
Overall, the 199 Local Group analogues chosen from the zoom simulations span a wide range of different two-halo systems embedded in different surroundings. Only the values near the very edges of the allowed ranges in each variable are rare. This offers an excellent opportunity of analysing the correlations of the mass of the system and its other properties and its surroundings.
