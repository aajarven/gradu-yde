...
Figure \ref{fig:hubblediagrams}: two different simulation, MW-centered, huom obs nb how different they are: scatter, number of haloes, changes in scatter (bound structures)

\begin{figure}
    \centering
    \def\svgwidth{\columnwidth}
    \input{kuvat/hubblediagrams.pdf_tex}
    \caption{Hubble Flows around Milky Way in two simulations.}\label{fig:hubblediagrams}
\end{figure}

%\begin{figure}
%   \centering
%   \includesvg{kuvat/hubblediagrams.svg}
%   %\includegraphics[width=\textwidth]{kuvat/hubblediagrams}
%   \caption{.}\label{fig:hubbleflow}
%\end{figure}
