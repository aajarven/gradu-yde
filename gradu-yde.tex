...
\begin{figure}
    ...
    \caption{Distributions of LG analogue properties. TODO: selitä, mieti miten y-akselin label}\label{fig:LGproperties}
\end{figure}
