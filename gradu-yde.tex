...
the Local Group has only one elliptical galaxy, which is a small satellite of the Andromeda galaxy \citep{sparke2007galaxies}. Current list of Local Group members might not be complete though as due the heavy absorption in the plane of the Milky Way it is possible that some members of the Local Group have not yet been discovered \citep{sparke2007galaxies}.
