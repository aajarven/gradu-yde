...
\makecell{1} & \makecell{0.015} & \makecell{-0.087} & \makecell{-0.318} & \makecell{0.129} & \makecell{0.087} & \makecell{-0.157} & \makecell{0.404} & \makecell{0.439} & \makecell{0.407} & \makecell{0.439} & \makecell{-0.058} & \makecell{-0.354}\\
	...
	\caption{Principal components of the twelve predictor variables measured from the simulations. These principal components have been extracted from the training set, containint 60~\% of the simulations in the full data set.}\label{tab:PCs}
\end{table}
