...
\begin{figure}
    ...
    \caption{Histograms of LG analogue properties. TODO: caption}\label{fig:LGproperties}
\end{figure}
...
\begin{figure}
    ...
    \caption{Mean H0 in different 2 Mpc bins. The grey curves show the $1 \sigma$ region around the mean.}\label{fig:shelledH0}
\end{figure}
