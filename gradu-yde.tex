...
The cosmology of the simulation is a standard $\Lambda$CDM cosmology with cosmological parameters of \citet{planck2014resultsXVI}, shown in table \ref{tab:cosmopars}. For a dark matter only simulation the $\Omega_b$ is naturally ignored and all matter treated as dark matter. The $\sigma_8$ parameter shown in the table is used to define the amplitude of the power spectrum in the initial conditions.
