...
The existence of such fundamental observer has interesting consequences. If a fundamental observer sees an isotropic universe, there cannot be any curl or flows in the observed velocity field, as that would be a deviation from the isotropy. Thus only allowed motions are 
