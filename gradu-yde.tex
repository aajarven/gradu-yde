...
These sections shortly describe the structure, kinematics and evolution of the Local Group with focus on the Milky Way and Andromeda galaxy pair, as these are the most dominant members and their coevolution is the most defining process in the Local Group. Their mutual dynamics also offer one way of estimating the mutual mass of the galaxy pair, which [jossain osassa esitellään, jossain arvioidaan vs muut menetelmät]. %TODO
