...
\begin{figure}
    ...
    \caption{Projections of haloes around the less massive LG primary with distances ranging from 1.5 Mpc to 5.0 Mpc. TODO caption}\label{fig:mollweide-anisotropy} %TODO
\end{figure}
