...
\begin{figure}
    ...
    \caption{The distribution of $H_0$ measurement results when subhaloes with angle between them and M31 is less than 45\textdegree (blue histogram), more than 135\textdegree (green histogram) or in between (orange curve).}\label{fig:threeDirectionH0}
\end{figure}

In order to compare the values of $H_0$ when measured towards or away from the M31 analogue or in the perpendicular direction, Fig.~\ref{fig:threeDirectionH0} shows the histograms of $H_0$ fitting results in these three $45 \degree$ bins.


%Fig.~\ref{fig:directionalHF} shows how the Hubble flow 
