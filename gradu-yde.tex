...
In order to avoid these problems, a new set of uncorrelated variables can be generated from the original predictors. In this work, this is done by extracting the principal components as described in section~\ref{sect:pca}. The weights that define the resulting principal components are presented in table \ref{tab:PCs} in appendix~\ref{app:pcs}. As these principal components are guaranteed to be orthogonal, the problems that arise from the correlations among the original predictors are avoided.
...
When all available data is used to construct the model, it is still possible to overfit the model to perform well on the values in the test set but possibly poorly on other data sets. In order to avoid this, 40~\% of the data set was set aside to be used in evaluating the accuracy of the final model. A 10-fold cross validation is then performed with the remaining 60~\% of the data. The RMS errors (black dots) in this training phase are shown in Fig.~\ref{fig:pca-rmse-training}, together with the RMS error of timing argument mass estimates on the same data points (red line). %TODO miten skaalaus yms
...
When only the first principal component is used to predict the mass of the Local Group, the regression coefficient for it is approximately $-1.968 \times 10^{11}$. %TODO yksikkö, miten tästä lasketaan ennusteita muille
...
\newpage
\appendix
\chapter{Principal Components} \label{app:pcs}
\setlength\tabcolsep{0.3em}
\begin{table}
	\centering
	\rotatebox{90}{
	\begin{tabular}{l | l l l | l l l | l l l | l l l}
      \thead{PC} & \thead{$H_0$} & \thead{$H_0$\\(clusted)} & \thead{$H_0$\\(not clustered)} & \thead{HF zero} & \thead{HF zero\\(clustered)} & \thead{HF zero\\(not clustered)} & \thead{$\sigma_{radvel}$} & \thead{$\sigma_{radvel}$\\(clustered)} & \thead{$\sigma_{radvel}$\\(not clustered)} & \thead{$v_{r, LG}$} & \thead{$v_{t, LG}$} & \thead{$r_LG$}\\
      \hline
	\makecell{1} & \makecell{-0.353} & \makecell{-0.211} & \makecell{-0.097} & \makecell{-0.415} & \makecell{-0.236} & \makecell{-0.150} & \makecell{-0.228} & \makecell{-0.461} & \makecell{-0.293} & \makecell{-0.461} & \makecell{0.005} & \makecell{0.084} \\ 
	\makecell{2} & \makecell{-0.360} & \makecell{-0.372} & \makecell{-0.407} & \makecell{-0.191} & \makecell{-0.097} & \makecell{-0.178} & \makecell{0.407} & \makecell{0.163} & \makecell{0.334} & \makecell{0.163} & \makecell{0.001} & \makecell{-0.398} \\ 
	\makecell{3} & \makecell{0.231} & \makecell{0.378} & \makecell{-0.465} & \makecell{0.210} & \makecell{0.096} & \makecell{-0.559} & \makecell{0.166} & \makecell{-0.218} & \makecell{0.098} & \makecell{-0.218} & \makecell{-0.280} & \makecell{0.112} \\ 
	\makecell{4} & \makecell{-0.021} & \makecell{-0.136} & \makecell{0.198} & \makecell{0.310} & \makecell{-0.076} & \makecell{0.384} & \makecell{0.419} & \makecell{-0.396} & \makecell{0.436} & \makecell{-0.396} & \makecell{-0.024} & \makecell{0.114} \\ 
	\makecell{5} & \makecell{0.202} & \makecell{-0.091} & \makecell{0.189} & \makecell{-0.006} & \makecell{-0.660} & \makecell{-0.025} & \makecell{-0.082} & \makecell{0.094} & \makecell{0.043} & \makecell{0.094} & \makecell{-0.667} & \makecell{-0.088} \\ 
	\makecell{6} & \makecell{0.236} & \makecell{0.041} & \makecell{-0.010} & \makecell{0.075} & \makecell{-0.598} & \makecell{-0.256} & \makecell{-0.051} & \makecell{0.026} & \makecell{0.200} & \makecell{0.026} & \makecell{0.675} & \makecell{0.121} \\ 
	\makecell{7} & \makecell{0.227} & \makecell{0.077} & \makecell{0.127} & \makecell{0.160} & \makecell{0.040} & \makecell{-0.030} & \makecell{-0.133} & \makecell{-0.205} & \makecell{-0.113} & \makecell{-0.205} & \makecell{0.121} & \makecell{-0.877} \\ 
	\makecell{8} & \makecell{0.168} & \makecell{-0.717} & \makecell{-0.103} & \makecell{0.524} & \makecell{0.084} & \makecell{-0.179} & \makecell{-0.035} & \makecell{0.012} & \makecell{-0.344} & \makecell{0.012} & \makecell{0.009} & \makecell{0.116} \\ 
	\makecell{9} & \makecell{0.058} & \makecell{0.032} & \makecell{0.513} & \makecell{-0.200} & \makecell{0.024} & \makecell{-0.354} & \makecell{0.655} & \makecell{0.015} & \makecell{-0.366} & \makecell{0.015} & \makecell{0.048} & \makecell{0.016} \\ 
	\makecell{10} & \makecell{-0.372} & \makecell{0.339} & \makecell{-0.278} & \makecell{0.382} & \makecell{-0.341} & \makecell{0.299} & \makecell{0.242} & \makecell{0.055} & \makecell{-0.498} & \makecell{0.055} & \makecell{0.046} & \makecell{-0.055} \\ 
	\makecell{11} & \makecell{-0.612} & \makecell{0.103} & \makecell{0.408} & \makecell{0.399} & \makecell{0.032} & \makecell{-0.416} & \makecell{-0.251} & \makecell{0.039} & \makecell{0.218} & \makecell{0.039} & \makecell{-0.045} & \makecell{-0.016} \\ 
	...
	\caption{Principal components of the twelve predictor variables measured from the simulations for the mass estimation.}\label{tab:PCs}
\end{table}
