...
%   [ ] LG-like analogues identified, span the range of allowed values
%   [ ] HF fitting schemea adapting to the variable size of LG
%   [ ] HF vs distance or direction
%   [ ] clustering parameters chosen and used
% [ ] The main question or problem statement has been answered.
%   [ ] better mass estimate
% [ ] The hypotheses have been confirmed or refused.
%   [ ] HF in clusters different
