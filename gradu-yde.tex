...
%Even the lowest $H_0$ value of $84.8$~km/s/Mpc is higher than the global value in the simulation as the Local Group affects the results. This category also has the largest scatter of values around the median.
