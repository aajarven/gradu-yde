...
\end{equation} %TODO nätimmäksi?
which yields an estimate of the mass in units of $\mathrm{M}_{\astrosun}$. 
...
Nonetheless, is clear that, at the expense of measuring more variables, it is possible to use tools of statistics and machine learning to obtain better estimates of the mass of the Local Group. %TODO haastavaa toistaa IRL Unfortunately, currently repeating the analysis 
