...
\begin{figure}
    ...
    \caption{Mean Hubble flow slope and zero point as seen from Milky Way analogue in different 20\textdegree\ bins as measured from line connecting Milky Way and Andromeda analogues, direction 0\textdegree\ being towards Andromeda. From each simulation bins with less than 10 subhaloes in them were excluded, total 25. TODO caption}\label{fig:directionalHF} %TODO
\end{figure}

\begin{figure}
    \centering
    \includegraphics{kuvat/threeDirectionH0.pdf}
    \caption{asfdsa 45\textdegree}\label{fig:threeDirectionH0} %TODO
\end{figure}
