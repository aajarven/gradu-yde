...
The peak of the radial velocity histogram is located near 100 km/s, meaning that most of the identified Local Group analogues have radial velocities near the measured value for the Andromeda galaxy \citep{vandermarel2012m31}. For tangential velocities, the distribution is much more uniform, though values near the ends of the allowed interval are rarer. The \citet{vandermarel2012m31} tangential velocity measurement result of 17.0~km/s would also fall in one of the densely populated bins, though the tangential velocity measurements have much bigger uncertainties than radial velocities: the $1\sigma$ confidence region extends up to 34.3~km/s, covering more than a half of the allowed range in the Local Group analogue identification criterion.

As can be seen in the overdensity plot, most of the Local Group analogues are located in an overdense region, but some are in very underdense regions. This is possible only if the primary haloes are on the lower end of the allowed mass range, they have only low mass satellites and there are no other comparable structures within the 2~Mpc distance. Very high density regions are also rare as they require either a halo with mass comparable to the primaries of the Local Group to fall within the region or a large number of smaller haloes. %TODO : overdensity plotissa ei kaikki massa vaan ainoastaan löydetyt subhalot, varmista että legit

The combined mass of the primaries in the Local Gorup analogues and its distribution between the thaloes also varies from simulation to simulation. This is illustrated in Fig. \ref{fig:LGmasses}, which shows mass of the more massive of the primaries against the combined mass of the two. The full possible vertical extent of the masses is marked with the grey lines, the lower one showing the threshold where the more massive halo holds exactly half of the total mass and the upper one illustrating the maximum possible mass in the more massive halo when the Local Group analogue criteria requires the smaller one to have a mass of at least $4 \times 10^{11}~\mathrm{M_{\astrosun}}$.
...
\subsection{Measuring the Hubble Flow}
