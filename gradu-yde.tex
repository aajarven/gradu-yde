...
\begin{figure}
    ...
    \caption{asdf}\label{fig:pca-cumulative-variance}
\end{figure}

\begin{figure}
    \centering
    \includegraphics{kuvat/PCA/scree.pdf}
    \caption{asdf}\label{fig:pca-scree}
\end{figure}

\begin{figure}
    \centering
    \includegraphics{kuvat/PCA/rmse-alldata.pdf}
    \caption{Effect of the number of used PCs on the mass fitting residual. The errors are from 10-fold CV of all data. huom obs nb: y axis limits}\label{fig:pca-rmse-alldata}
\end{figure}
