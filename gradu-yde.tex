...
In addition to Milky Way and the Andromeda galaxy, the Local Group has only one other spiral galaxy: the Triangulum galaxy, one of the satellites of the Andromeda galaxy and a third-most luminous galagy in the Local Group \citep{sparke2007galaxies}. The Local Group has only one elliptical galaxy, which is a small satellite of the Andromeda galaxy \citep{sparke2007galaxies}. [jatka tähän että maistuu kokonainen kappale] % 4.2

Rest of the galaxies in the Local Group are dwarf spheroidals or irregular galaxies \citep{sparke2007galaxies}. Due to the heavy absorption in the plane of the Milky Way, it is possible that some members of the Local Group are not yet discovered \citep{sparke2007galaxies}. [jatka tähän myös] % magellanic clouds esimerkkinä?
