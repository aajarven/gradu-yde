...
First, Local Group analogues were identified in all of the catalogues. 

%- parentista poiketen zoomeissa korkeampi resoluutio kiinnostavissa osissa
%- halo finding -> data minulle
%- Subhalo catalogs from 448 resimulations, cut down by by:
%-- No LG in all of them
%-- Contamination
%-- Duplicates
%- Result: 126 Local Groups
%-- löytyivätkö samat halot kuin parentista piti?


%Softening length 1.0 kpc/h in all zooms.
