...
A more adaptable solution to studying the anisotropy of the Hubble flow is to apply a clustering algorithm to the data sets in order to discover groups of subhaloes located near each other on the sky as seen from the Milky Way analogues and then compare Hubble flow fits of these clusters. For this, the DBSCAN algorithm introduced in section~\ref{sect:cluster-analysis} is used. %TODO mitkä parametrit, miten valittu
