...
Regression analysis is a set of statistical analysis processes that are used to estimate functional relationships between variables \citep{feigelson2012modern}. Linear regression model 
\begin{equation}
	yhtalo
\end{equation}
