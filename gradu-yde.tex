...
Even then, the masses of the Local Group as a whole and its most massive members are still uncertain. For example different acknowledged estimates of the mass of the Milky Way from the past ten years easily differ by a factor of 3 \citep{wang2015estimating}. This is due to most of the mass being dark matter, which cannot be directly observed. Most of the mass estimates rely on the kinematics in the system and estimating the mass by analysing orbits of either individual galaxies or point sources such as masers or high velocity stars.

%TODO mainitse TA ja siirry sitten tilastoihin

%TODO :
% - helppo havaita (muut galaksit) mutta vaikea havaita (MW) 
% - mass ?
% - can be measured kinematically
% - could it also be estimated statistically?
