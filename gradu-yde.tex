...
\begin{itemize}
\item Mutual distance of the haloes lies between 700 and 840 Mpc.
...
\end{itemize}
The criteria were chosen so that the systems resemble the Local Group but the ranges are wide enough to accommodate uncertainties in the observed values and to produce a large enough data set for statistical analysis.
