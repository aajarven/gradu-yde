...
Regression analysis is a set of statistical analysis processes that are used to estimate functional relationships between variables \citep{feigelson2012modern}. One of the models used Linear regression model 
\begin{equation}
	y = \beta_0 + \beta_1 x_1 +\,\dots\, + \beta_p x_p + \varepsilon
\end{equation}
is one of the models used in regression analysis
